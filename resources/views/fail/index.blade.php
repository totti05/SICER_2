            ...
            <div id="formvarFiltro" class="form-group">
              ...
              <select id="varFiltro" name="varFiltro" class="form-control">
                <option value="" selected> </option>
                 ...
                 <option>Ánodos Rajados </option>
                 <option>Ánodos Tetas </option>
                 <option>Ánodos Cambio Quemado por Sobreconducción(BO) </option>
                 <option>Ánodos extras </option>
                 <option>Atrasos Banqueo de Ánodos </option>
                 <option>Peso de Ánodo </option>
